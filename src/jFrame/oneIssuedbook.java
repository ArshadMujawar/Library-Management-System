 ...
 * @author admin
 */
public class oneIssuedbook extends javax.swing.JFrame {
  ...
  //to fetch issue book deatails from the database and display it to book detail Panel
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(oneIssuedbook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new oneIssuedbook().setVisible(true);
            }
        });
    }
